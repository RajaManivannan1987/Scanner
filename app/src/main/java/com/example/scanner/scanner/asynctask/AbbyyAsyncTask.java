...
import com.example.scanner.scanner.abbyyocr.Client;
import com.example.scanner.scanner.abbyyocr.ProcessingSettings;
import com.example.scanner.scanner.abbyyocr.Task;
import com.example.scanner.scanner.activity.ResultsActivity;

import java.io.FileOutputStream;

public class AbbyyAsyncTask extends AsyncTask<String, String, Boolean> {

	public AbbyyAsyncTask(ResultsActivity activity) {
	...
	protected Boolean doInBackground(String... args) {
		...
		try {
			...
			restClient.applicationId = "com.example.scanner.scanner";
			// You should get e-mail from ABBYY Cloud OCR SDK service with the application password
			restClient.password = "Nra6epoVfYrWI/Svc4KzgfsssNi";
